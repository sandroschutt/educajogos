...
import victoryModal from "../../template/modals/victory.js";
...
$("#game").append(tip);
$(".tip").text(
  wordObject.tip.charAt(0).toUpperCase() + wordObject.tip.slice(1)
);
...
function lose() {
  let lostGameMessage =
    '<h3 class="text-center text-white">Você perdeu... :(</h3>';
  alert("perdeu");
